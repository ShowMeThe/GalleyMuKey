package com.example.main.ui.main.adapter
...
import com.example.main.databinding.ItemLikeListBinding
...
class LikeListAdapter(context: Context, data: ObservableArrayList<PhotoWallBean>) :
    ...
    override fun bindItems(binding: ItemLikeListBinding?, item: PhotoWallBean, position: Int) {
        binding?.apply {
            ...
            container.background  = CreateDrawable.create(context,CornerFamily.CUT,15,R.color.colorAccent)
