...
public class CaptureManager {
    ...
    private BarcodeCallback callback = new BarcodeCallback() {
        ...
        public void barcodeResult(final BarcodeResult result) {
            ...
            handler.post(new Runnable() {
                @Override
                public void run() {
                    Intent intent = resultIntent(result, getBarcodeImagePath(result));
                    if(barCodeResultCallBack!=null){
                        ...
                        new IntentResult(contents, formatName, rawBytes, orientation, errorCorrectionLevel,
                                barcodeImagePath);
                        if(barCodeResultCallBack.callBack(
                                new IntentResult(contents, formatName, rawBytes, orientation, errorCorrectionLevel,
                                barcodeImagePath))){
                            //true 返回前一页
                            activity.finish();
    ...
    private onBarCodeResultCallBack barCodeResultCallBack;

    public void setOnBarCodeResultCallBack(onBarCodeResultCallBack barCodeResultCallBack){
        this.barCodeResultCallBack = barCodeResultCallBack;
    }

    public interface onBarCodeResultCallBack{
        boolean callBack(final IntentResult intent);
    }
