package showmethe.github.kframework.widget.animView
...
class RectScaleAnim @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
    ...
    internal var delays = intArrayOf(200, 300, 400, 100, 200, 300, 0, 100, 200)
    /**
     * 动画集合
     */
