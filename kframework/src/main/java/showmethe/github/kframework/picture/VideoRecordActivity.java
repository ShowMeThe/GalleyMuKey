...
public class VideoRecordActivity extends AppCompatActivity {
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            ...
            cameraDevice.close();
            mCameraDevice = null;
            Activity activity = VideoRecordActivity.this;
            if (null != activity) {
                activity.finish();
            }
        }
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            Observable.create(new ObservableOnSubscribe<String>() {
                ...
                public void onNext(String s) {
                    Toast.makeText(VideoRecordActivity.this,"保存"+ s,Toast.LENGTH_SHORT).show();
                }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
          ...
          Toast.makeText(VideoRecordActivity.this,"配置错误",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void takePicture() {
        ...
        photoPath = dir.getPath() + "/" + System.currentTimeMillis() + ".jpg";
        mFile = new File(photoPath);
        Log.e("Start","TakePhoto");
        lockFocus();
    }
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        if (mNextVideoAbsolutePath == null || mNextVideoAbsolutePath.isEmpty()) {
            mNextVideoAbsolutePath = Environment.getExternalStorageDirectory() + File.separator + "/Pictures/" + System.currentTimeMillis() + ".mp4";
        }
    ...
    private void stopRecordingVideo() {
        ...
        Toast.makeText(VideoRecordActivity.this,"保存"+ mNextVideoAbsolutePath,Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button.setOnRecordListener(new RecordButton.OnRecordListener() {
    ...
    private static  final int PERMISSION_CODE =  5001;
