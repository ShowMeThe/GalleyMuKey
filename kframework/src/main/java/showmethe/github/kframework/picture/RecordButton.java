...
public class RecordButton extends View {
     ...
     * 长按最短时间  单位毫秒
     */
    public long LONG_CLICK_MIN_TIME = 200;
    ...
    private void initData(Context context, AttributeSet attrs) {
        ...
        excicleMagnification = a.getFloat(R.styleable.RecordButton_excicleMagnification
                , EXCICLE_MAGNIFICATION);
        innerCircleShrinks = a.getFloat(R.styleable.RecordButton_excicleMagnification
        ...
        mInitExCircleRadius = mExCircleRadius = a.getDimension(R.styleable.RecordButton_excircleRadius
                , VIDEO_RECORD_DEFAULT_EXCIRCLE_RADIUS);
        mInitInnerRadius = mInnerCircleRadius = a.getDimension(R.styleable.RecordButton_innerCircleRadius
                , VIDEO_RECORD_DEFAULT_INNER_CIRCLE_RADIUS);

        mAnnulusColor = a.getColor(R.styleable.RecordButton_annulusColor
                , VIDEO_RECORD_DEFAULT_ANNULUS_COLOR);
        mInnerCircleColor = a.getColor(R.styleable.RecordButton_innerCircleColor
                , VIDEO_RECORD_DEFAULT_INNER_CIRCLE_COLOR);
        mProgressColor = a.getColor(R.styleable.RecordButton_progressColor
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (mEndTime - mStartTime < LONG_CLICK_MIN_TIME) {
                    ...
                    if (mProgressAni != null && mProgressAni.getCurrentPlayTime() / 1000 < mMinTime) {
                        ...
                        Observable.timer(mMinTime, TimeUnit.SECONDS).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
    ...
    static class MHandler extends android.os.Handler {
        ...
        private WeakReference<RecordButton> weakReference = null;

        public MHandler(RecordButton controlView) {
            weakReference = new WeakReference<RecordButton>(controlView);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            final RecordButton videoControlView = weakReference.get();
            switch (msg.what) {
                case RecordButton.MSG_START_LONG_RECORD:
